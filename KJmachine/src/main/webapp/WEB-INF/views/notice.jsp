  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
	 ...
	 <form  action="/upload" method="post" role="form" enctype="multipart/form-data">
          ...
          <span class="form-group">
            <label>상품이름</label> <input class="form-control" name="mach_name" >
          </span>
          <span class="form-group">
            <label>상품상태</label> <input class="form-control" name="condit">
          </span>
           <div class="form-group">
            <label>제조사</label> <input class="form-control" name="manufacture">
          </div>
           <div class="form-group">
            <label>제조년월</label> <input class="form-control" name="mfg">
          </div>
           <div class="form-group">
            <label>상품위치</label> <input class="form-control" name="located">
          </div>
           <div class="form-group">
            <label>상품사양</label> <input class="form-control" name="specification">
          </div>
          <div class="form-group">
            <label>상품 내용</label>
          ...
          <div class="form-group">
            <label>상품가격</label> <input class="form-control" name="price">
          </div>
           <div class="form-group">
            <label>거래가능지역</label> <input class="form-control" name="dealArea">
          </div>
           <div class="form-group">
            <label>인도조건</label> <input class="form-control" name="delivery">
          </div>
